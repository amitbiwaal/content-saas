...
export default tseslint.config(
  {
    ignores: [
      '**/dist/**',
      '**/node_modules/**',
      // Generated by `vitest --coverage`. Already ignored by prettier and git;
      // without it here, running the suite with coverage locally makes the next
      // lint fail on v8's bundled report scripts, which belong to no project.
      'coverage/**',
      'backend/**',
      'frontend/**',
      'archive/**',
