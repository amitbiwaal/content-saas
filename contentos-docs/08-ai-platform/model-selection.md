...
Consumed by the Model Router as policy input; transport via `09-integrations/openrouter.md`. This file plus the Router's task table together are the complete, auditable routing truth.
